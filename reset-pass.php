...
if(isset($_POST["e"])){	
	...
	$e_check2 = mysqli_num_rows($query);
	if($email == ""){
		...
		$to = "$email";							 
		$from = "kaziweb-noreply@kaziweb.com";
		$subject = 'KaziWeb Account Forgot Password';
		...
		$message .= '<div style="padding: 20px;background-color: rgb(217, 226, 245);"><a href="http://www.kaziweb.com/reset&'.$eo_hash.'">Click here to reset password</a></div>';
		$message .= '<br /><br /><br /><span style="font-size:16px;"><b>Bacsyd Security Team</b></span></body></html>';
		$headers = "From: kaziweb-noreply@kaziweb.com\r\n";
		$headers .= "Reply-To: kaziweb-noreply@kaziweb.com\r\n";
		$headers .= "Return-Path: kaziweb-noreply@kaziweb.com\r\n";
		$headers .= "CC: kaziweb-noreply@kaziweb.com\r\n";
		$headers .= "BCC: kaziweb-noreply@kaziweb.com\r\n";
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> 
	  ...
	  <a class="brand" href="javascript:void(0)" onclick="kazihome()">
