  ...
  <div class="everything-everything"> <!--style="filter:blur(3px)" -->
	<div class="subnavbar">
	  <div class="subnavbar-inner">
		<div class="container">
		  <ul class="mainnav">
			<li class="active"><a href="javascript:void(0);" onclick="kazihome()"><i class="fa fa-dashboard"></i><span>Dashboard</span> </a> </li>
...
<?php include_once("_ext/dashboard_kazi-box.php");?>
</body>
</html>